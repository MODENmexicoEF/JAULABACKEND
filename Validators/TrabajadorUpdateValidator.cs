...
{
    public class TrabajadorUpdateValidator : AbstractValidator<TrabajadorUpdateDto>
    {
        public TrabajadorUpdateValidator()
        {
            RuleFor(x => x.TrabajadorId).NotEmpty().WithMessage("El id es obligatorio");
